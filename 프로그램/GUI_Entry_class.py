...
class Entry_User():
    ...
    def __init__(self,window,x,y):
        ...
        self.Fbirth_combobox = ttk.Combobox(window,values= F_list,state ="readonly")
        self.Fbirth_combobox.place(x=x+170,y=y+30,width=60)
        self.Fbirth_combobox.set('선택')

        S_list = ['01','02','03','04','05','06','07','08','09','10','11','12']

        self.Sbirth_combobox = ttk.Combobox(window,values=S_list,state ="readonly")
        ...
        self.Tbirth_combobox = ttk.Combobox(window,values=T_list,state ="readonly")
        ...
        a = ["010","016","011"]
        self.Phone_combobox = ttk.Combobox(window,values=a,state="readonly")
